  ...
  return (
    <section className={styles.favoriteCoinsSection} aria-label="TradingView Verified Asset Markets">
      <div className="container">
        ...
        >
          <div className={styles.topBadgePill}>
            <span className={styles.greenDot} />
            <span>TRADINGVIEW VERIFIED SYMBOLS · 100+ MARKETS</span>
          </div>

          <h2 className={styles.title}>
            Trade your <span>favorite coins </span> &amp; assets
          </h2>

          <p className={styles.subtitle}>
            Sub-second real-time neural telemetry across Crypto, Forex, Indices, and Commodities with institutional AI signals.
          </p>
        </motion.div>
      </div>
