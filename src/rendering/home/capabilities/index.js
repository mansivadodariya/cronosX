                      ...
                      <motion.div
                        ...
                        animate={{
                          ...
                          background: hoveredIndex === 0 
                            ? 'linear-gradient(90deg, #D8A23B 0%, #FFE693 100%)' 
                            : 'rgba(255, 255, 255, 0.18)',
                          boxShadow: hoveredIndex === 0 ? '0 0 14px rgba(255, 230, 147, 0.7)' : 'none'
                        }}
                ...
                <svg viewBox="0 0 240 135" className={styles.breakoutSvg}>
                  <defs>
                    <linearGradient id="breakoutAreaGradGold" x1="0%" y1="0%" x2="0%" y2="100%">
                      <stop offset="0%" stopColor="#D8A23B" stopOpacity="0.35" />
                      <stop offset="60%" stopColor="#9E6B17" stopOpacity="0.1" />
                  ...
                  {hoveredIndex === 2 ? (
                    <g>
                      ...
                      {/* Surging Moving Upward Line in Gold */}
                      <motion.path
                ...
                <svg viewBox="0 0 240 110" className={styles.equitySvg}>
                  <defs>
                    <linearGradient id="eqGlowGradGold" x1="0%" y1="0%" x2="0%" y2="100%">
                      <stop offset="0%" stopColor="#D8A23B" stopOpacity="0.4" />
                      <stop offset="60%" stopColor="#9E6B17" stopOpacity="0.1" />
                      <stop offset="100%" stopColor="#D8A23B" stopOpacity="0" />
                    </linearGradient>
                  </defs>
