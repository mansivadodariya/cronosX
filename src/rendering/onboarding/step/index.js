...
const SproutIcon = () => (
    <div className={styles.icon3dWrapper}>
        <svg width="44" height="44" viewBox="0 0 36 36" fill="none">
            <path d="M18 30V18M18 18C18 12 11 10 7 11C7 16 11 20 18 18ZM18 18C18 10 25 8 29 9C29 14 25 18 18 18Z" stroke="#F4D17A" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" fill="url(#sprout-grad)" />
            <path d="M12 30H24" stroke="#F4D17A" strokeWidth="2" strokeLinecap="round" />
            <defs>
                <linearGradient id="sprout-grad" x1="7" y1="8" x2="29" y2="30" gradientUnits="userSpaceOnUse">
                    <stop stopColor="#FFE79A" stopOpacity="0.85" />
                    <stop offset="1" stopColor="#C1902E" stopOpacity="0.45" />
                </linearGradient>
            </defs>
        </svg>
    </div>
...
const GrowthChartIcon = () => (
    <div className={styles.icon3dWrapper}>
        <svg width="44" height="44" viewBox="0 0 36 36" fill="none">
            <rect x="5" y="22" width="5" height="8" rx="1.5" fill="url(#bar-grad)" stroke="#F4D17A" strokeWidth="1.6" />
            <rect x="13" y="16" width="5" height="14" rx="1.5" fill="url(#bar-grad)" stroke="#F4D17A" strokeWidth="1.6" />
            <rect x="21" y="10" width="5" height="20" rx="1.5" fill="url(#bar-grad)" stroke="#F4D17A" strokeWidth="1.6" />
            <path d="M5 16L13 10L21 6L29 2M29 2H23M29 2V8" stroke="#FFE79A" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" />
            <defs>
...
const LightningIcon = () => (
    <div className={styles.icon3dWrapper}>
        <svg width="44" height="44" viewBox="0 0 36 36" fill="none">
            <path d="M20 4L8 19H18L16 32L28 17H18L20 4Z" fill="url(#bolt-grad)" stroke="#F4D17A" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
            <defs>
...
const TrophyIcon = () => (
    <div className={styles.icon3dWrapper}>
        <svg width="44" height="44" viewBox="0 0 36 36" fill="none">
            <path d="M10 6H26V15C26 19.4 22.4 23 18 23C13.6 23 10 19.4 10 15V6Z" fill="url(#trophy-grad)" stroke="#F4D17A" strokeWidth="2" strokeLinejoin="round" />
            <path d="M10 9H6C4.9 9 4 9.9 4 11V13C4 15.2 5.8 17 8 17H10.5" stroke="#F4D17A" strokeWidth="1.8" strokeLinecap="round" />
            <path d="M26 9H30C31.1 9 32 9.9 32 11V13C32 15.2 30.2 17 28 17H25.5" stroke="#F4D17A" strokeWidth="1.8" strokeLinecap="round" />
            <path d="M18 23V27M13 31H23M15 27H21" stroke="#F4D17A" strokeWidth="2" strokeLinecap="round" />
            <defs>
